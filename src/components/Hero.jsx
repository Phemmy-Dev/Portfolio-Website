...
const Hero = () => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Phemmy-Dev', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/oluwafemi-akinruntan/', label: 'LinkedIn' },
    { icon: Twitter, href: 'https://x.com/Phemmy_dev', label: 'Twitter' },
    { icon: Mail, href: 'mailto:oluwafemiakinruntan1@gmail.com', label: 'Email' },
  ];
        ...
        <div className="text-center space-y-8">
          ...
          >
            <h1 className="text-4xl lg:text-6xl xl:text-5xl font-display font-bold">
              ...
              <span className="text-gradient">Oluwafemi.</span>
            </h1>
